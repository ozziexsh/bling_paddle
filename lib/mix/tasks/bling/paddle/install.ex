defmodule Mix.Tasks.Bling.Paddle.Install do
  @moduledoc """
  ...
  """
  @shortdoc "Copies the required files to use the bling_paddle package."
  ...
  defp copy_subscription_schemas(project_directory, dep_directory, module_name) do
    ...
    receipt_stub_path = Path.join([dep_directory, "stubs/receipt_schema.ex.stub"])
    ...
    Mix.Generator.copy_template(receipt_stub_path, receipt_final_path, module_name: module_name)
  end
